...
public class YwclDbsxTsclZywzcFailureData extends ExcelObject {
	// Ywlb Suggestion Dqhj Clfs Tips
	private String ywlb;
	private String dqhj;
	...
	public String toString() {
		return "YwclDbsxTsclZywzcFailureData [ywlb=" + ywlb + ", dqhj=" + dqhj + ", suggestion=" + suggestion
				+ ", clfs=" + clfs + ", tips=" + tips + "]";
	}
